                ...
                <div class="card">
                    <div class="card-header ">
                        ...
                        <button class="btn btn-sm btn-primary" style="float: right;" data-bs-toggle="modal"
                            data-bs-target="#exampleModal">Add New Student </button>
                    </div>

                    <div class="card-body">
                        @if (session()->has('messege'))
                        <div class="alert alert-success text-center">{{ session('messege') }}</div>
                        @endif
                    </div>
                </div>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <form wire:submit.prevent="storeStudentData">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" id="name" class="form-control" wire:modal="name">
                                @error('name')
                                    <span class="text-danger" style="font-size: 11.5px;">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="email" id="email" class="form-control" wire:modal="email">
                                @error('email')
                                    <span class="text-danger" style="font-size: 11.5px;">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="number" id="phone" class="form-control" wire:modal="phone">
                                @error('phone')
                                    <span class="text-danger" style="font-size: 11.5px;">{{ $message }}</span>
                                @enderror
                            </div>
